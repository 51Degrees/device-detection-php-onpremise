...
echo "<p><br/>\n";
echo "    IsMobile: " . (isset($device->ismobile) && $device->ismobile->hasValue ? $device->ismobile->value : "Unknown (" . (isset($device->ismobile) ? $device->ismobile->noValueMessage : "property unavailable" ) .")") . "<br />\n";
echo "</p>";
echo "</div><br>\n";
