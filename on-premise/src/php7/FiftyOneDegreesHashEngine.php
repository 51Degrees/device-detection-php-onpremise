...
class MapStringStringSwig {
	...
	function __construct($other=null) {
		if (is_resource($other) && get_resource_type($other) === '_p_std__mapT_std__string_std__string_std__lessT_std__string_t_t') {
			$this->_cPtr=$other;
			return;
		}
		switch (func_num_args()) {
		case 0: $this->_cPtr=new_MapStringStringSwig(); break;
		default: $this->_cPtr=new_MapStringStringSwig($other);
		}
	}
...
class VectorStringSwig {
	...
	function __construct($n_or_other=null) {
		...
		default: $this->_cPtr=new_VectorStringSwig($n_or_other);
		}
	}
